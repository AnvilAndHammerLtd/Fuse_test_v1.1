 ...
 * <p/>
 * Requests that have to do with the Company. Example: retrieving a company's details
 */
public class CompanyService {
     ...
     * <p/>
     * on success the {@link CompanyFragment#onEventMainThread(CompanyEvent event)}
     * <br/>
     * on failure the {@link CompanyFragment#onEventMainThread(ErrorEvent event)}
     *
